...
#ifndef _AM_C_MEMORY_H
#define _AM_C_MEMORY_H

#include "amplitude_common.h"

#ifndef AM_NO_MEMORY_STATS

struct am_memory_pool_stats;
 ...
 */
typedef struct am_memory_allocator_vtable
{
    /**
 ...
 *
 * @param[in] config The memory manager configuration.
 *
